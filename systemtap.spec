...
Patch11: BZ1095137.patch
Patch12: BZ1099133.patch
Patch13: BZ1099472.patch
Patch14: BZ1099555.patch
Patch15: BZ1099757.patch
Patch16: BZ1099791.patch
Patch17: BZ1099825.patch
Patch18: BZ1100813.patch
Patch19: BZ1109084.patch
...
%configure %{?elfutils_config} %{dyninst_config} %{sqlite_config} %{crash_config} %{docs_config} %{pie_config} %{publican_config} %{rpm_config} %{java_config} --disable-silent-rules --with-extra-version="rpm %{version}-%{release}" have_fop=no
make %{?_smp_mflags}
...
%changelog
* Mon Jun 23 2014 Frank Ch. Eigler <fche@redhat.com> - 2.5-5
- refreshed BZ1109084.patch

* Fri Jun 20 2014 Frank Ch. Eigler <fche@redhat.com> - 2.5-4
- added BZ1099133.patch: at_var_cu test
- added BZ1099472.patch: cast-scope.exp test
- added BZ1099555.patch: gtod.exp test 
- added BZ1099757.patch: vars.exp test
- added BZ1099791.patch: vma_vdso test
- added BZ1099825.patch: probe_by_pid test
- added BZ1100813.patch: buildok tests
- added BZ1109084.patch: initscript name sensitivity

* Mon May 12 2014 Frank Ch. Eigler <fche@redhat.com> - 2.5-3
- Include fix for RHBZ1095137: semantic error ... syscall.sendfile

* Fri May 02 2014 Frank Ch. Eigler <fche@redhat.com> - 2.5-2
- Include fix for upstream http://sourceware.org/PR16894

* Thu May 01 2014 Frank Ch. Eigler <fche@redhat.com> - 2.5-1
- rebase to upstream 2.5 release, including fixes for:
- rhbz1027459: staprun/stapio fails if trace1 file is in same dir
- rhbz1074541: kernel crash on netfilter_drop.stp sample
- rhbz1038692: systemtap missing syscall pwritev

* Tue Dec 10 2013 Frank Ch. Eigler <fche@redhat.com> - 2.3-4
- rhbz1020437: irq vector tracepoints

* Mon Sep 30 2013 Lukas Berk <lberk@redhat.com> - 2.3-3
- rhbz996084: systemtap.exelib/exelib.exp regressed on s390x and x86_64
- rhbz996077: systemtap.base/utrace_p5.exp got unstable on i686 and x86_64
- rhbz874205: [FJ6.2 Bug] systemtap crashes

* Wed Sep 25 2013 Lukas Berk <lberk@redhat.com> - 2.3-2
- rhbz998595: rpm -V systemtap-server complains
- rhbz996091: systemtap.syscall/syscall.exp regressed on i686 and x86_64
- rhbz996084: systemtap.exelib/exelib.exp regressed on s390x and x86_64
- rhbz996097: systemtap.base/execve.exp fails on i686 and ppc64
- rhbz996079: systemtap.base/warn_overflow.exp regressed on i686 and ppc64
- rhbz915180: utrace_syscall_args.exp on s390x: "FAIL: 32_BIT_UTRACE_SYSCALL_ARGS shutdown (eof)"
- rhbz996065: systemtap.base/bz10078.exp regressed
- rhbz996072: systemtap.base/kmodule.exp regressed on s390x and ppc64
- rhbz996080: systemtap.context/fib.exp regressed on s390x
- rhbz996103: systemtap.base/bad-code.exp regressed on s390x
- rhbz1008567: broken tapsets on s390x - print_ubacktrace() and print_ubacktrace_brief()
- rhbz996087: systemtap.server/server_locale.exp regressed on all arches

* Thu Jul 25 2013 Frank Ch. Eigler <fche@elastic.org> - 2.3-1
- Upstream release.

* Thu Dec 03 2012 Mark Wielaard <mjw@redhat.com> - 1.8-7
- rhbz884951: nfs_proc.stp should fetch inode from nfs_pgio_header

* Fri Sep 21 2012 Frank Ch. Eigler <fche@redhat.com> - 1.8-6
- rhbz824311: workarounds for incomplete rpc kernel tracepoint headers
 
* Fri Sep 21 2012 Frank Ch. Eigler <fche@redhat.com> - 1.8-5
- rebased to systemtap 1.8, including scox's fixes from rhel-5.9:
- rhbz844910: grumble quietly about preexisting gid/uid conflicts in .spec  
- rhbz843480: systemtap-server should work without systemtap-runtime preinstalled
- rhbz843392: systemtap-testsuite unresolved deps
- rhbz843389: sdt.c on systemtap-testsuite cannot be compiled
- rhbz835027: systemtap-testsuite requires prelink on ia64
- Backported fix for pr14325
- No publican in rhel 5.
- Add s390 to the publican blacklist.
- rebase
- Backported fixes for pr14230 pr14296

* Fri May 04 2012 Stan Cox <scox@redhat.com> - 1.7-5
- Backported additional fix for bz813323

* Tue Apr 26 2012 Stan Cox <scox@redhat.com> - 1.7-4
- Backported fixes for bz812871 and bz813323

* Tue Mar 06 2012 Stan Cox <scox@redhat.com> - 1.7-3
- Backported fix for bz790091

* Tue Mar 06 2012 Stan Cox <scox@redhat.com> - 1.7-2
- Backported fixes for rhbz743591 rhbz795913 rhbz791243 bz798754 bz790091 bz798797

* Wed Feb 01 2012 Frank Ch. Eigler <fche@redhat.com> - 1.7-1
- Upstream release.

* Mon Dec  5 2011 Stan Cox <scox@redhat.com> - 1.6-6
- Add missing commit for rhbz757802

* Wed Nov 23 2011 Stan Cox <scox@redhat.com> - 1.6-5
- Backported fixes for rhbz756432, rhbz757118, rhbz757723, rhbz757802

* Wed Oct 17 2011 Stan Cox <scox@redhat.com> - 1.6-4
- Backported fixes for rhbz730884 rhbz733182
- rhel5 backport by <fche>

* Wed Sep 21 2011 Stan Cox <scox@redhat.com> - 1.6-3
- rhel6 bonus backports bz731288, bz732346, bz737095, bz738242, bz639344
- rhel5 backport by <fche>

* Tue Aug 16 2011 Stan Cox <scox@redhat.com> - 1.6-2
- bz730167

* Tue Jul 26 2011 Frank Ch. Eigler <fche@redhat.com> - 1.6-1
- rebase

* Thu Jul  8 2011 Stan Cox <scox@redhat.com> - 1.3-9
- bz716489 (patch)

* Fri Jun  3 2011 Stan Cox <scox@redhat.com> - 1.3-8
- Improved bz699342 (patch)

* Thu Jun  2 2011 Stan Cox <scox@redhat.com> - 1.3-7
- bz699342 (patch)

* Fri May 13 2011 Stan Cox <scox@redhat.com> - 1.3-6
- bz702687 (patch)

* Mon Apr 11 2011 Frank Ch. Eigler <fche@redhat.com> - 1.3-5
- bz607232 (patch)
- bz646870 (bundle newer elfutils)
- bz644350 (patch)
- bz661424 (patch)
- bz559599 (patch)
